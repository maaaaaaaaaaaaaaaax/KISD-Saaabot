...
def main():
    with Printer() as p:
        ...
        try:
            ...
            p.print_image("https://i.pinimg.com/736x/83/09/3b/83093beeb304768a3b3e5f0b7979e221.jpg", alignment='center')
            p.feed(1)
        ...
        try:
            p.print_image("examples/printer/assets/gamba.png", rotation=90, alignment='center')
            p.feed(1)
        except FileNotFoundError:
            p.print_text("   [Image not found]")
            p.feed(1)
        ...
        try:
            p.print_image("examples/printer/assets/gamba.png", width=200, alignment='center')
            p.feed(1)
        except FileNotFoundError:
            p.print_text("   [Image not found]")
            p.feed(1)
        ...
        try:
            ...
            # Combine
            combined = processor.combine_horizontal(img1_resized, img2_resized, spacing=15)
