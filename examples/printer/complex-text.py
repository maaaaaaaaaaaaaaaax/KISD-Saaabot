...
from printer import ComplexTextBlockStyle, ComplexTextSpan, Printer
...
def main():
    with Printer() as p:
        ...
        complex_spans = [
            ComplexTextSpan(
                "PRICE AND ", font_family="monospace", font_size=30, bold=True
            ),
            ...
            ComplexTextSpan(
                ", Some serif text, this is some serif text.\n",
                font_family="serif",
                font_size=22,
            ),
            ComplexTextSpan(
        ...
        p.print_complex_text(
            spans=[
                ComplexTextSpan(
                    "This is a long text that should wrap around to"
                    " the next line if it exceeds the printer's"
                    " width. It demonstrates automatic text"
                    " wrapping in complex text blocks.",
                    font_family="sans",
                    font_size=20,
                )
            ],
