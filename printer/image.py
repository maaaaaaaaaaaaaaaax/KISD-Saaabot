...
class ImageProcessor:
    ...
    def rotate(self, image: Image.Image, degrees: float, expand: bool = True) -> Image.Image:
        """
    ...
    def prepare_for_print(
        ...
        if image.width > max_width:
            image = self.resize(image, target_width=max_width, maintain_aspect=maintain_aspect)
